...
Oct 2018
ICS2O3
Compliment to PD_Improved_House
*/
import java.awt.*;
import java.awt.Rectangle;
import java.awt.event.KeyEvent;

public class PD_Tiefighter
{
    static int vel;
    static Graphics g;
    Color body;
    ...
    public PD_Tiefighter(Graphics g, PD_Improved_House house)
    {
      this.g=g;
      this.house = house;
    }
    ...
    {
      Rectangle tie = new Rectangle(tiex[0],tiey[1],tiex[3] - tiex[0],tiey[4] - tiey[2]);
      Rectangle tie2 = new Rectangle(tie2x[0],tie2y[1],tie2x[3] - tie2x[0],tie2y[4] - tie2y[2]);
      Rectangle laser_g = new Rectangle(startx,starty,bs,1);
      Rectangle laser_r = new Rectangle(start2x,start2y,bs,1);
      return(tie.intersects(tie2) || laser_g.intersects(tie2) || laser_r.intersects(tie));
    }
